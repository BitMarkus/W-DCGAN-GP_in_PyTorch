...
setting = {
    ...
    # Training parameters
    "batch_size": 10,                       # Strongly depends on the number of filters! around 32      
    "num_epochs": 500, 
    ...
    # Adds adaptive noise that decreases over training and prevents critic overfitting early on
    # Noise decays linearly from max_noise_std to min_noise_std
    ...
    # SelfAttention
    "use_attention": True,                  # Enable/disable attention modules
    "attention_layers": ["middle"],         # Where to add attention: ["early", "middle", "late"]
    "attention_min_channels": 128,          # Minimum channels needed for attention
    "generate_att_maps_epochs": 1,
